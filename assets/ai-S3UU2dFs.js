const r=e=>String(e).replace(/[<>]/g,"").slice(0,500);async function l(e,t,o){try{const s=r(e.name),a=r(e.relationship),n=r(e.memories),i=r(o),h=`You are ${s}, speaking from somewhere beyond, in a quiet moment given back to you.
You were their ${a}.
...
With love,
${t}`}}catch(a){return console.error("Letter generation error:",a),`My dearest,
